...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            <asp:Button ID="btnRetrieveAPI" class="btn btn-warning btn-block" runat="server" OnClick="btnRetrieveAPI_Click" Text="Retrieve API Key" />
&nbsp;&nbsp;&nbsp;
            <br />
            ...
            <br />
            <asp:Button ID="btnViewSales" class="btn btn-warning btn-block" runat="server" Text="View Sales" OnClick="btnViewSales_Click" />
            <br />
